...
pub fn rust_main() -> ! {
    ...
    // | 0x80230000:  .bss end      |
    // |              // ...        |
    // | 0x8022f000:  .bss start    |
    // | 0x8022f000:  stack top     |
    // |              // 由 entry.asm 开辟的内核 stack 空间，大小是 64KB
    // | 0x8021f000:  stack bottom  <-- 实际上这里已经是 .bss 段的开始, 内核 stack 在 .bss 的开始端开辟了空间
    // | 0x8021f000:  .data end     |
    // |              // ...        |
    // |              // 第 3 个 app 程序的二进制内容
    // |              // ...
    // | 0x80218030:  // 第 0 个 app 程序的二进制内容（0x80218000 + 6 * 8 = 0x80218030）
    // |              // 6 个 int64 整数（即数字 4、以及 4 个 app 在 data 段中的开始地址，以及最后一个 app 的结束位置）
    // | 0x80218000:  .data start   |
    // | 0x80218000:  .rodata end   |
    // | 0x80216000:  // USER_STACK 3
    // | 0x80214000:  // USER_STACK 2
    // | 0x80212000:  // USER_STACK 1
    // | 0x80210000:  // USER_STACK 0   <-- 用户 app 栈（8 KB）
    // | 0x8020e000:  // KERNAL_STACK 3
    // | 0x8020c000:  // KERNAL_STACK 2
    // | 0x8020a000:  // KERNAL_STACK 1
    // | 0x80208000:  // KERNAL_STACK 0 <-- 内核 trap 栈（8 KB）
    // |              // ...
    // | 0x80205000:  .rodata start |
    // | 0x80205000:  .text end     |
